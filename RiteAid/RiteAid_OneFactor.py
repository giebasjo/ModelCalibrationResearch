...
riteAid_outFile = open('riteAid_results.csv', 'w')
riteAid_PdLgdFile = open('riteAid_PdLgdResults.csv', 'w')
...
for k in dateToData.keys():
    ...
    if (spd != 0.0):
        ...
        try:
            ...
            ## Calibrate
            CalibA, CalibSigA = fsolve( fsolve_function, init_guess, args=(E*1000000, sig_E, N, r, M) )
            ...
            d_spread = delta_spread( A, CalibSigA, E*1000000, sig_E, N, r, M, spd )
            ...
            riteAid_outFile.write( out_str )
            
            out_str2 = str(bta) + "," + str(LGD) + "," + str(PD) + "\n"
            riteAid_PdLgdFile.write( out_str2 )
...
riteAid_outFile.close()
riteAid_PdLgdFile.close()
